...
const [projects, setProjects] = useState([
    ...
    { id: 4, img: "/photos/infinity.png", name: "Infinity", tech: "React Native / Expo , Node.js / Express.js, Java, Axios, JWT", desc: "Enterprise-grade full-stack automation for Sunmi hardware. Engineered a custom Java Native Module (Bridge) for low-level thermal printing integrated with a React Native/Expo client. Powered by a secure Node.js/Express API (JWT), asynchronous Axios data syncing, and professional 6-language localization (i18n).", link: "https://github.com/KedyCodeur/Infinity" },
    { id: 5, img: "/photos/lolo.png", name: "Ciné Lolo", tech: "PHP, MySQL, SQL", desc: "Full-stack PHP/SQL movie browsing & purchasing solution. Developed under strict 'JavaScript Prohibited' constraint. Features secure login, persistent cart logic, and advanced relational modeling. SUPINFO 2026.", link: "https://github.com/KedyCodeur/Cine--Lolo-fullstack" },
    { id: 6, img: "/photos/glpi.png", name: "Cyber-GLPI (PoC)", tech: "GLPI, Windows Server, AD DS,  DNS,  AD CS,  IIS,  GPO, PHP, MariaDB, PowerShell & Batch,  Firewall,  VMware", desc: "School project (SUPINFO Paris): GLPI helpdesk PoC on Windows Server — IIS, HTTPS (AD CS), AD DS, DNS, GPO , Firewall, VMware, PowerShell & Batch, PHP, MariaDB, GLPI agent auto-deploy on domain join, automated inventory, disk alert tickets & AD domain authentication.", link: "https://github.com/KedyCodeur/Project-Cyber-Glpi" },
    { id: 7, img: "/photos/yearbook.png", name: "YearBookCreator", tech: "Python", desc: "Developed a Python tool to generate yearbooks with a cover page, class photo, and individual student pages showing names, surnames, and quotes. Uses Pillow for image resizing, blurring, color or B/W display, and badges for class reps. Modular code with no globals, focused on quality and maintainability.", link: "https://github.com/KedyCodeur/pillowYearbook_Creator" },
    { id: 8, img: "/photos/livcen.png", name: "OmdbApiProjectJs", tech: "HTML, CSS, JavaScript.", desc: "Developed a responsive movie application using HTML, CSS, and JavaScript. Integrated with the OMDb API to display trending movies, perform real-time searches without page reloads, and show detailed movie information including posters, summaries, genres, and cast. Used modular JS files and followed best practices for clean, maintainable code.", link: "https://github.com/KedyCodeur/OmdbApiProjectJs" },
    { id: 9, img: "/photos/felin.png", name: "L-Assosiation-F-lin", tech: "HTML,CSS", desc: "A simple, responsive website for a cat-help organization, built only with HTML and CSS.", link: "https://github.com/KedyCodeur/L-Assosiation-F-lin" },
    { id: 10, img: "/photos/kedybot.png", name: "KedyBot", tech: "Discord.js, Python", desc: "Multilingual (TR/FR) Discord bot featuring interactive games like Snake/Duel, robust music playback, and personalized favorite song management for enhanced server engagement.", link: "https://github.com/KedyCodeur/KedyBot" }
]);
